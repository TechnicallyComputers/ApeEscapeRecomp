...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "ApeEscape",
    .project_root_env = "APEESCAPERECOMP_PROJECT_ROOT",
    .build_dir_env = "APEESCAPERECOMP_BUILD_DIR",
    .force_setup_env = "APEESCAPERECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_944.23_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "ApeEscapeRecomp",
    .prepare_note =
